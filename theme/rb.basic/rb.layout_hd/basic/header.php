        ...
        <div class="gnb_wrap">
            ...
            <div class="inner" style="width:<?php echo $tb_width_inner ?>; <?php echo $tb_width_padding ?>">
                ...
                <nav id="cbp-hrmenu" class="cbp-hrmenu pc">
                    ...
                    ?>
                    <li>
                        <a href="<?php echo $row['me_link']; ?>" target="_<?php echo $row['me_target']; ?>" class="font-B"><?php # echo $row['me_name'] ?><?php echo __($row['me_name'], []) ?></a>
                        <?php
                        $k = 0;
                ...
                <ul class="snb_wrap">
                    ...
                    <li class="my_btn_wrap">
                        <?php if($is_member) { ?>
                            <button type="button" alt="로그아웃" class="btn_round" onclick="location.href='<?php echo G5_BBS_URL ?>/logout.php';"><?php echo __('logout', []) ?></button>
...
function changeLanguage(lang) {
    ...
    xhr.open('POST', '/lang/i18n.php', true);
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            // 성공적으로 언어 변경, 필요시 페이지 새로고침
            location.reload();
...
$(document).ready(function() {
        if ($('li.qm_wrap').length) {
            var newElement = $(
                '<li id="google_notranslate_top">' +
                '<a href="javascript:void(0)"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/ko.png" style="height:20px !important;" /></a>' + // 기본적으로 한국어로 표시
                '<div class="translation-links">' +
                '<a href="javascript:void(0)" class="lang_ko" data-lang="ko" data-placement="0"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/ko.png" alt="한국어" style="height:20px !important;" /></a>' +
                                '<a href="javascript:void(0)" class="lang_en" data-lang="en" data-placement="1"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/en.png" alt="영어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_zh-CN" data-lang="zh-CN" data-placement="2"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/zh-CN.png" alt="중국어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_ja" data-lang="ja" data-placement="3"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/ja.png" alt="일본어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_vi" data-lang="vi" data-placement="4"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/vi.png" alt="베트남어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_ru" data-lang="ru" data-placement="5"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/ru.png" alt="러시아어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_fr" data-lang="fr" data-placement="6"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/fr.png" alt="프랑스어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_de" data-lang="de" data-placement="7"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/de.png" alt="독일어" style="height:20px !important;" /></a>' +
                                                '<a href="javascript:void(0)" class="lang_th" data-lang="th" data-placement="8"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/th.png" alt="태국어" style="height:20px !important;" /></a>' +
                                '</div>' +
                '</li>'
            );
            $('li.qm_wrap').after(newElement);
        }
            ...
            const observer = new MutationObserver(function(mutations) {
                mutations.forEach(function(mutation) {
                    mutation.addedNodes.forEach(function(node) {
                        if (node.classList && node.classList.contains('goog-te-combo')) {
                            observer.disconnect();
                        }
                    });
                });
        ...
        document.addEventListener('click', function(event) {
            if (event.target.closest('.translation-links a')) {
                ...
                if (el) {
                    ...
                    console.log(el.dataset.lang);
                    changeLanguage(el.dataset.lang);
                    return false;
                    if (gtcombo) {
                        gtcombo.value = tolang;
                        gtcombo.dispatchEvent(new Event('change'));
                        document.querySelectorAll('.sv_member').forEach(function(element) {
                            element.classList.add('notranslate');
                        });
                        updateLanguage(tolang);
                        localStorage.setItem('selectedLanguage', tolang);
        ...
        window.addEventListener('load', function() {
            ...
            if (savedLang) {
                ...
                updateLanguage('ko'); // 기본적으로 한국어 아이콘을 표시합니다.
            }
        });

        $('#google_notranslate_top').hover(
            function() {
                $(this).find('.translation-links').show();
            },
            function() {
                if (!$(this).find('.translation-links').is(':hover')) {
                    $(this).find('.translation-links').stop(true, true).hide();
                }
            }
        );
        ...
        function updateLanguage(langCode) {
            $('#google_notranslate_top').html(
                '<a href="javascript:void(0)"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/' + langCode + '.png" style="height:20px !important;" /></a>' +
                '<div class="translation-links">' +
                '<a class="lang_ko" data-lang="ko" data-placement="0"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/ko.png" alt="한국어" style="height:20px !important;" /></a>' +
                                '<a class="lang_en" data-lang="en" data-placement="1"><img src="https://demo.rebuilder.co.kr/rb/rb.mod/lang//image/en.png" alt="영어" style="height:20px !important;" /></a>' +
                                '</div>'
            );
        }
    });
